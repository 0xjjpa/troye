    ...
    <>
      ...
      <main style={{ position: 'relative' }}>
        ...
        >
          ...
          {qrcodePayload &&
            <Flex direction="column" height="80vh" justifyContent="space-around">
              <Text fontSize="4xl">{getHash(qrcodePayload.publicKeyAsHex || 'empty')}</Text>
              <Button>Load Troye Id</Button>
            </Flex>
          }
        </Flex>
      </main>
